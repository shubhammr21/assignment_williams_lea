...
class LegislationContextTests(TestCase):
    ...
    def test_get_context_success(self):
        xml_content = b"""
        <root xmlns:leg="http://www.legislation.gov.uk/namespaces/legislation" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:atom="http://www.w3.org/2005/Atom">
            ...
            <leg:SecondaryPrelims DocumentURI="http://example.com/doc">
                ...
                <leg:Subject><leg:Title>Subject Title</leg:Title></leg:Subject>
                <leg:MadeDate><leg:Text>Made Date Text</leg:Text><leg:DateText>2024-10-09</leg:DateText></leg:MadeDate>
                <leg:ComingIntoForce><leg:Text>Coming Into Force Text</leg:Text><leg:DateText>2024-10-10</leg:DateText></leg:ComingIntoForce>
